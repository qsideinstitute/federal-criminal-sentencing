...
```{r}
amodel <- lm(flipper_length_mm ~ species, 
             data = pengAdelie)
amodel
```
...
<!-- FIX THIS SECTION WITH THE REGRESSION LINE ON THE BOXPLOT-->
...
ggplot(pengAdelie, aes(y = flipper_length_mm, x = species, group = species)) +
  geom_boxplot() +
