...
So far we've only explored linear regression with numerical variables, but we can use categorical variables as well. Let's compare flipper length to penguin species. Remember that flipper length is a numerical varible and species is a categorical variable with three levels (Adelie, Chinstrap, and Gentoo).
