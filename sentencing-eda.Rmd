...
```
##### Ridge plot of sentence length in months vs. criminal history
...
ggplot(us_sent) +
  geom_point(aes(y = sentence_length, 
                 x = base_chapter2_3_adjustments), alpha = 0.3) +
  labs(x = "Sentence length in months", 
       y = "Base Chapter2_3_adjustments")
```
