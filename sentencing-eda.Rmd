...
When we are exploring the distribution of a dataset can we can use a number of different plots
...
Could we add vertical bars to the plot to reflect the table and make the year marks. 

Say something about skew and also particular peaks relative to the table.
