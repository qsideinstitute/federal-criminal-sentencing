...
```{r}
ggplot(us_sent) +
  geom_density_ridges(aes(y = as.factor(criminal_history), x = sentence_length, fill = as.factor(criminal_history))) +
  labs(fill = "Criminal History", x = "Sentence length in months", y = "Criminal History")
```

#### How does criminal history vary with age?
